    ...
    if(msg.room){
      ...
      if(msg.text=='join'){
        if(currentPlayerSet.size>=10) await room.say('too many players!');
          ...
          if(flag==false){
            playerPointer = new newPlayer(msg.from());
          ...
          if(currentPlayerSet.size==2){
            ...
            await room.say('your turn!',new Array(currentPlayer));
          }
          else await room.say(statusToMsg());
        }
      }
